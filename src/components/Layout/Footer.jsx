                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8 xl:col-span-1">
                        ...
                        <p className="text-gray-500 text-base">
                            Helping parents monitor and understand their children's growth patterns for healthier development.
                        </p>
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul className="mt-4 space-y-4">
                                    ...
                                    <li>
                                        <Link to="/children/charts" className="text-base text-gray-500 hover:text-gray-900">
                                            Growth Charts
                                        </Link>
                                    </li>
                                </ul>
